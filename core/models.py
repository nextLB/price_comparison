...
class Drug(models.Model):
    ...
    description_dosage_form = models.CharField(max_length=100, blank=True, verbose_name='表述剂型')
    spec_package = models.CharField(max_length=500, blank=True, verbose_name='规格包装')
    ...
    package_quantity = models.CharField(max_length=50, blank=True, verbose_name='包装数量')
    ...
    catalog_holder = models.CharField(max_length=300, blank=True, verbose_name='目录序号&标化持有人')
    ...
    standard_mark = models.CharField(max_length=100, blank=True, verbose_name='标准品标记')
    ...
    unit_value = models.DecimalField(max_digits=20, decimal_places=6, default=0, verbose_name='单体差比值')
